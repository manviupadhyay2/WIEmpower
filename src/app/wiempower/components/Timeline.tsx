        ...
        <div className="min-h-screen bg-black p-8">
            <div className="max-w-6xl mx-auto">
                ...
                <div ref={timelineRef} className="relative">
                    <motion.div
                        className="absolute left-0 md:left-1/2 transform -translate-x-1/2 w-1 bg-gradient-to-b from-purple-500 via-blue-500 to-purple-500 rounded-full"
                        style={{ height: 0 }}
                    ...
                    {EVENTDATA.map((event, index) => {
                        ...
                        return (
                            ...
                            >
                                {/* Dot with alternating position */}
                                <motion.div
                                    className={`absolute ${isLeft ? 'right' : 'left'}-[-8px] md:left-1/2 transform md:-translate-x-1/2 

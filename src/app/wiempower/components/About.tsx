    ...
    <section className="min-h-screen flex items-center justify-center bg-black p-8">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16">
        ...
        <div className="lg:w-1/2 text-center lg:text-left space-y-6">
          <h2 className="text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-yellow-500 hover:scale-105 transition-transform duration-500">
            WIEmpower 5.0
          </h2>
          <p className="text-white text-opacity-90 text-lg font-light leading-relaxed tracking-wide">
